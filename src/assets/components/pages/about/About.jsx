...
const About = () => {
  ...
  const handleScroll = () => {
    if (experienceRef && experienceRef.current) {
      ...
      const topEdge = rect.top > -rect.height && rect.top < windowHeight;
        ...
        <div className={s.globalContainer}>
          <div className={s.sectionContent}>
            ...
            <div className={s.bestBlock}>
              ...
              <p className={s.bestBlockText}>The future is bright, the future is digitalization. Let's help each other
                bring the light closer. Your partner in the world of technology.</p>
              ...
              <div ref={experienceRef} className={s.bestBlockItems}
                ...
                <AboutCount
                  skills='JS / React / TypeScript / Svelte'
                ...
                <AboutCount
                  skills='html / css / scss / bem / rem / pug'
                  isAnimation={animation}
                  limit={70}
                />
